                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{route('admin.warehouse.exportWarehouse',['id'=>$warehouseDetail->id])}}"
                                                    ...
                                                    <td>
                                                        <div class="btn-box">
                                                            <div class="info-product d-none">
                                                                ...
                                                                <span class="prd-amount">{{$item->amount}}</span>
                                                            </div>
                                                            <button class="btn btn-info" onclick='confirmProduct(this)'><i class="fas fa-angle-double-right"></i></button>
                                                            <a href="{{route('admin.warehouse.postExportProductWarehouse',
                                                                ['id'=>$warehouseDetail->id,'warehouse_product_id'=>$item->warehouse_product_id])}}"
...
<script>
    ...
    function confirmProduct(e) {
        ...
        var amount = infoPrd.find('.prd-amount').text()
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                if(value && value.match(regex)) {
                    if(parseInt(value, 10) > amount) {
                        Swal.showValidationMessage(
                            'Số lượng nhập phải nhỏ hơn hoặc bằng số lượng trong kho'
                        )
                    } else {
                        return
                    }
