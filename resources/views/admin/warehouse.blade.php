                      ...
                      <div class="card-header">
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <input type="text" id="inputName" class="form-control" name="warehouse_name" value="{{old('warehouse_name')}}" placeholder="Tên kho">
                                ...
                                <div class="col-4">
                                    <input type="text" id="inputName" class="form-control" name="warehouse_address" value="{{old('warehouse_address')}}" placeholder="Địa chỉ">
                                    ...
                                    @if (!empty($warehouseList[0]))
                                        @foreach ($warehouseList as $warehouse)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-box">
                                                        <a href="{{route('admin.warehouse.editWareHouse',['id'=>$warehouse->id])}}" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                                        <a href="{{route('admin.warehouse.deleteWareHouse',['id'=>$warehouse->id])}}"
