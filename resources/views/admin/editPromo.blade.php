                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" class="form-control" name="promo_code" value="{{old('promo_code') ?? $promoDetail->code}}" placeholder="Mã khuyến mại">
                                    @error('promo_code')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="inputDescription" class="form-control" rows="4" name="promo_info" placeholder="Thông tin khuyến mại">{{old('promo_info') ?? $promoDetail->info}}</textarea>
                                    @error('promo_info')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="promo_apply form-control" name="promo_apply" style="width: 100%;">
                                                <option {{$promoDetail->subject_apply == "Sản phẩm" ? "selected" : ""}} value="Sản phẩm">Sản phẩm</option>
                                                <option {{$promoDetail->subject_apply == "Đơn hàng" ? "selected" : ""}} value="Đơn hàng">Đơn hàng</option>
                                                <option {{$promoDetail->subject_apply == "Khách hàng" ? "selected" : ""}} value="Khách hàng">Khách hàng</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="inputName" class="promo_total_money form-control" name="promo_total_money" value="{{old('promo_total_money') ?? $promoDetail->total_money}}" placeholder="VNĐ">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="promo_unit custom-select" name="promo_unit" style="width: 100%;">
                                                <option {{$promoDetail->unit == "%" ? "selected" : ""}} value="%">%</option>
                                                <option {{$promoDetail->unit == "VNĐ" ? "selected" : ""}} value="VNĐ">VNĐ</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="inputName" class="promo_discount form-control" name="promo_discount" value="{{old('promo_discount') ?? $promoDetail->discount}}" placeholder="%">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control float-right" name="date_range" value="{{old('date_range') ?? $promoDetail->date_range}}" id="reservation">
                                            </div>
                                            @error('date_range')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
